...
export default function Contact() {
    return (
        <div className="w-full flex-col flex items-center justify-center">
            ...
            <div className="card bg-base-100 w-[600px] border border-dotted border-neutral/80">
                ...
                <div className="bg-primary/10 px-5 py-8 text-center border-b border-primary">
                    ...
                    <p className="text-neutral text-base">
                        যে কোনো প্রশ্ন বা সমস্যার জন্য আমাদের সাথে যোগাযোগ করুন
                    </p>
                </div>
            ...
            <div className="mt-5">
                <Link className="text-sm font-normal text-neutral underline" href={route('ui.contact.index')}>আপনার মতামত জানাতে এখানে ক্লিক করুন।</Link>
            </div>
